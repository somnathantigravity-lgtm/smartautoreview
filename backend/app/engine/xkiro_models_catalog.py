...
===============================================
These are the ACTUAL models available on xKiro.com, verified via the /models API endpoint.
Old model IDs like 'claude-3-5-sonnet', 'gpt-4o' etc. do NOT exist on xKiro.
...
XKIRO_MASTER_MODELS: List[Dict[str, str]] = [
    # --- Anthropic ---
    ...
    # --- SenseNova ---
    {"id": "sensenova/sensenova-6.7-flash-lite", "name": "SenseNova 6.7 Flash Lite", "provider": "SenseNova", "badge": "Fast"},
    {"id": "sensenova/sensenova-6.8-flash-lite", "name": "SenseNova 6.8 Flash Lite", "provider": "SenseNova", "badge": "Latest"},
...
def get_model_count() -> int:
    return len(XKIRO_MASTER_MODELS)


def get_all_provider_names() -> list:
    """Returns unique provider names in display order."""
    seen = []
    for m in XKIRO_MASTER_MODELS:
